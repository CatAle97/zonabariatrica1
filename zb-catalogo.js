...
const productos = [
  ...
  { id:"lp1", tipo:"pack", marcaTipo:"lvl",
    ...
    desc:"El pack más completo de LVL Drink. Proteína, colágeno y fibra en un solo pedido.",
    incluye:"Proteína en Polvo 1kg (sabor a elegir) · Colágeno Hidrolizado 500g · Fibra Manzana Verde 200g",
    tags:["3 productos","27g proteína","Apto bariátrico"],
    precio:389, precioN:397, ahorro:8,
  ...
  { id:"lp2", tipo:"pack", marcaTipo:"lvl",
    ...
    nombre:"Pack Proteína + Colágeno",
    desc:"Proteína en Polvo HIGH ISO + Colágeno Hidrolizado SKINFINITY.",
    incluye:"Proteína en Polvo 1kg (sabor a elegir) · Colágeno Hidrolizado 500g",
    tags:["2 productos","27g proteína","10,000 mcg biotina"],
    precio:309, precioN:318, ahorro:9,
  ...
  { id:"lp3", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack Proteína + Fibra",
    desc:"Proteína en Polvo HIGH ISO + Fibra Manzana Verde.",
    incluye:"Proteína en Polvo 1kg (sabor a elegir) · Fibra Manzana Verde 200g",
    tags:["2 productos","27g proteína","6g fibra"],
  ...
  { id:"lp4", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack Colágeno + Fibra",
    desc:"Colágeno Hidrolizado SKINFINITY + Fibra Manzana Verde.",
    incluye:"Colágeno Hidrolizado 500g · Fibra Manzana Verde 200g",
    tags:["2 productos","10,000 mcg biotina","6g fibra"],
    precio:179, precioN:188, ahorro:9,
    img: LVL+"pack-colageno-fibra.jpg",
    uso:"Consulta las dosis individuales en cada envase.", tn:null },

  { id:"lp5", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack Doble Fibra",
    desc:"Dos potes de Fibra Manzana Verde. Ideal para el cuidado intestinal.",
    incluye:"Fibra Manzana Verde x2 (200g c/u)",
    tags:["400g en total","6g fibra","Tránsito intestinal"],
    precio:149, precioN:158, ahorro:9,
    img: LVL+"pack-doble-fibra.jpg",
    uso:"Disolver 1 scoop (10g) en 250ml de agua al día.", tn:null },

  { id:"lp6", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack Doble Colágeno",
    desc:"Dos potes de Colágeno Hidrolizado SKINFINITY.",
    incluye:"Colágeno Hidrolizado x2 (500g c/u)",
    tags:["1kg en total","10,000 mcg biotina","Piel y cabello"],
    precio:209, precioN:218, ahorro:9,
    img: LVL+"pack-doble-colageno.jpg",
    uso:"Disolver 1 scoop (12g) en 250ml de agua al día.", tn:null },

  { id:"lp7", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack 2 Proteínas",
    desc:"Proteína Chocolate + Proteína Vainilla. Ambos sabores para variar.",
    incluye:"Proteína Chocolate 1kg · Proteína Vainilla 1kg",
    tags:["2kg en total","Ambos sabores","27g proteína"],
    precio:399, precioN:418, ahorro:19,
    img: LVL+"pack-2proteinas.jpg",
    uso:"Disolver 1 scoop (40g) en 250ml de agua al día.", tn:null },

  /* Packs LVL que faltaban, agregados el 16-09-2026.
     ---------------------------------------------------------
  ...
  { id:"lp8", tipo:"pack", marcaTipo:"lvl",
    ...
    desc:"Dos envases de Proteína en Polvo HIGH ISO sabor chocolate, 1kg cada uno.",
    incluye:"Proteína Chocolate 1kg x2",
    tags:["2kg en total","27g proteína","100% cacao"],
    precio:399, precioN:418, ahorro:19,
    img: LVL+"pack-doble-choco.jpg",
    uso:"Disolver 1 scoop (40g) en 250ml de agua al día.", tn: tn.lvl_pro },

  { id:"lp9", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack Doble Proteína Vainilla",
    desc:"Dos envases de Proteína en Polvo HIGH ISO sabor vainilla, 1kg cada uno.",
    incluye:"Proteína Vainilla 1kg x2",
    tags:["2kg en total","27g proteína","Stevia natural"],
    precio:399, precioN:418, ahorro:19,
  ...
  { id:"lp11", tipo:"pack", marcaTipo:"lvl",
    brand:"LVL Drink", eligibleForBnQuantityDiscount:false, cat:"pack", marca:"LVL Drink",
    nombre:"Pack Mini LVL",
    desc:"Presentaciones mini de los suplementos LVL, para probar los sabores antes de decidirse por el envase grande. Sin azúcar añadida, endulzados con stevia.",
    incluye:"Presentaciones mini de los suplementos LVL Drink",
    tags:["Para probar","Varios sabores","Sin azúcar añadida"],
    precio:89, precioN:169, ahorro:80,
    img: LVL+"pack-mini.jpg",
    uso:"Cada presentación trae su propia indicación en el envase.", tn:null },
